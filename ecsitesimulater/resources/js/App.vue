        ...
        <div>
          <div class="main">
            <div class="tab-container">
              ...
              <div
                :class="{
                  'tab-click-left': isOverworldClick,
                  'tab-left': !isOverworldClick,
                }"
              >
                <button
                  @click="setOverworldClick(true)"
                  :class="{
                    'tab-world-click': isOverworldClick,
                    'tab-world': !isOverworldClick,
                  }"
                >
                  オーバーワールド
                </button>
              ...
              <!--エンドボタン-->
              <div
                :class="{ 'tab-click': isEndTabClick, tab: !isEndTabClick }"
        ...
        <div>
          ...
          <div class="recipe">
            <div class="recipe-inline">
              <div
                class="recipe-box"
                v-for="(recipe, i) in itemRecipeList"
                :key="i"
              >
                <!--クラフト不可レシピ-->
                ...
                <div v-if="recipe.crafttable_id === 2">
                  <ul>
                    <li>
                      <img
                        src="./assets/img/architecture/acacia_log.webp"
                        alt=""
                      />
                    </li>
                    <li>
                  ...
                  <div class="right-side">
                    <div class="square-button">
                      <button type="submit">
                        <img
                          src="src\assets\img\web_png\web_png\return.png"
                          alt=""
                        />
                      </button>
                    </div>
