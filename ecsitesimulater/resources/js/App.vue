...
<template>
    <div
        :class="{ 'whole-nether': isNetherTabClick, 'whole-overworld': !isNetherTabClick, 'whole-end': isEndTabClick, 'whole-all': isAllTabClick }">
        <!--タイトルロゴ画像-->
            ...
            <div class="split">
                    ...
                    <div class="main">
                        <div class="tab-container">
                            ...
                            <div :class="{ 'tab-click': isEndTabClick, 'tab': !isEndTabClick }"
                                @click="setEndTabClick(true)">
                                <button
                                    :class="{ 'tab-world-click': isEndTabClick, 'tab-world': !isEndTabClick }">エンド</button>
                            </div>
                            <!--オールボタン-->
                ...
                <div>
                    ...
                    <div class="recipe">
                        ...
                        <!--仮デザイン-->
                        <h3 style="color: white; background-color: black;" v-if="itemRecipeNote">※{{ itemRecipeNote }}</h3>
                    </div>
                </div>
            </div>
        </div>
